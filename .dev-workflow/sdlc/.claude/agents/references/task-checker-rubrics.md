...
A framing aid for reading the diff like a senior reviewer answering one question — "would
a staff engineer approve this for merge?" Each dimension maps onto a Canonical audit axis
you already score; record every finding under the Canonical axis named here, never under a
