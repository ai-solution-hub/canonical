...
Spec source: `docs/specs/astro-starlight-docs-foundation/PRODUCT.md` Inv-51,
...
This project is indexed by GitNexus as **knowledge-hub** (45952 symbols, 65753 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
