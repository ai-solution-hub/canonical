...
Ashcombe Environmental Ltd is a fictional supplier used as synthetic pipeline-test
content. It carries no real company, client or contract information. Ashcombe
Environmental Ltd was established as a specialist provider of ecology surveys and
biodiversity net-gain assessment for highways schemes, and works almost exclusively with
UK public-sector buyers through open tenders, framework call-offs and mini-competitions.

## Delivery model

Ashcombe Environmental Ltd runs a single delivery function with named leads for
...
The Ashcombe Environmental Ltd management system is certified to NSI 50001 by an
...
the current NSI 50001 certificate is issued to buyers at contract award and reissued on
renewal.

## Social value and sustainability

Ashcombe Environmental Ltd reports social value against the buyer's chosen framework, with
...
Ashcombe Environmental Ltd is governed by a small executive team, with functional leads
