...
split ACROSS two documents (synthetic-inv-14-pair-resolver-run-b.md is the sibling) and must stay that way.
...
# Supplier profile — Marchmont Energy Systems Ltd, assurance record A (Synthetic)
...
The Marchmont Energy Systems Ltd management system is certified to CYE 14001 by an
accredited certification body, and the certificate is subject to annual
surveillance. This record writes the standard in its spaced form; the company's
