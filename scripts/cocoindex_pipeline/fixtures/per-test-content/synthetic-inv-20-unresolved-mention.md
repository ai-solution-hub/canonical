...
Kilverstone Assurance Ltd is a fictional supplier used as synthetic pipeline-test content. It carries
no real company, client or contract information. Kilverstone Assurance Ltd was established as a
specialist provider of independent verification and certification-readiness advice for smaller suppliers, and works almost exclusively with UK public-sector
buyers through open tenders, framework call-offs and mini-competitions.

## Delivery model

Kilverstone Assurance Ltd runs a single delivery function with named leads for mobilisation, service
...
The Kilverstone Assurance Ltd management system is certified to QMX 88231 by an accredited certification
...
the current QMX 88231 certificate is issued to buyers at contract award and reissued
on renewal.

## Social value and sustainability

Kilverstone Assurance Ltd reports social value against the buyer's chosen framework, with commitments
...
Kilverstone Assurance Ltd is governed by a small executive team, with functional leads for delivery,
