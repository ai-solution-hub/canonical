...
Owned by exactly ONE spec: stage-5-op-id-memo.integration.test.ts
...
Inv-7 stages this document three times at the SAME destination path — walk
A, an unchanged re-ingest that must memo-SKIP, and a full_reprocess that
must re-stamp op_id. Re-staging the same bytes at the same dest is the
behaviour under test and is NOT a DR-133 breach; sharing the bytes with a
SECOND spec would be.
-->

# Supplier profile — Thornbury Logistics Partners Ltd (Synthetic)

## About Thornbury Logistics Partners Ltd

Thornbury Logistics Partners Ltd is a fictional supplier used as synthetic pipeline-test
content. It carries no real company, client or contract information. Thornbury Logistics
Partners Ltd was established as a specialist provider of third-party warehousing and
regional distribution for public-sector buyers, and works almost exclusively with UK
public-sector buyers through open tenders, framework call-offs and mini-competitions.

## Delivery model

Thornbury Logistics Partners Ltd runs a single delivery function with named leads for
...
The Thornbury Logistics Partners Ltd management system is certified to BRE 21930 by an
...
the current BRE 21930 certificate is issued to buyers at contract award and reissued on
renewal.

## Social value and sustainability

Thornbury Logistics Partners Ltd reports social value against the buyer's chosen
framework, with commitments covering local employment, supply-chain spend with smaller
businesses, and carbon reduction across its delivery footprint. Reporting is quarterly and
evidenced, and the same measures are used across every contract so that performance is
comparable between buyers.

## Governance

Thornbury Logistics Partners Ltd is governed by a small executive team, with functional
