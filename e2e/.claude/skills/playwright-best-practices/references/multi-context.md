...
This file covers **single-user scenarios** with multiple browser tabs, windows, and
popups. For **multi-user collaboration testing** (multiple users interacting
simultaneously), see [multi-user.md](multi-user.md).
...
> see [third-party.md](third-party.md#oauthsso-mocking). This section focuses on popup
> window handling mechanics for OAuth flows.
...
> **For multi-user collaboration patterns** (admin/user interactions, real-time
> collaboration, role-based testing, concurrent actions), see
> [multi-user.md](multi-user.md). This file focuses on single-user scenarios with multiple
> tabs/windows/popups.
