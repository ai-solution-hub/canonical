...
> **For comprehensive waiting strategies** (navigation, element state, network, polling
> with `toPass()`), see [assertions-waiting.md](assertions-waiting.md#waiting-strategies).
...
- **Assertions**: See [assertions-waiting.md](assertions-waiting.md) for auto-waiting
  patterns
