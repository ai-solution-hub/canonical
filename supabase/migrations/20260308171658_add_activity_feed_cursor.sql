-- Migration: Add cursor-based pagination (p_before) to get_grouped_activity_feed
-- Replaces offset-based pagination with a TIMESTAMPTZ cursor for efficient
-- page-through of the activity feed.
