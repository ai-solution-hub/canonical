...
-- ID-42 (deploy pullmd + retire HTML extraction) — TECH §WP-D (docs/specs/pullmd-deploy/TECH.md)
...
COMMENT ON COLUMN public.source_documents.pullmd_share_id IS
  'pullmd X-Share-Id permalink (GET /s/:id round-trips); ID-42 (docs/specs/pullmd-deploy/TECH.md WP-D)';
