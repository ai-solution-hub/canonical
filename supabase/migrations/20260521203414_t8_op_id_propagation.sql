...
COMMENT ON COLUMN public.content_items.op_id IS 'Cocoindex per-flow op_id; T8 (docs/specs/cocoindex-flow-scaffolding/TECH.md §P-4)';
...
COMMENT ON COLUMN public.q_a_extractions.op_id IS 'Cocoindex per-flow op_id; T8 (docs/specs/cocoindex-flow-scaffolding/TECH.md §P-4)';
...
COMMENT ON COLUMN public.source_documents.op_id IS 'Cocoindex per-flow op_id; T8 (docs/specs/cocoindex-flow-scaffolding/TECH.md §P-4)';
...
COMMENT ON COLUMN public.pipeline_runs.op_id IS 'Cocoindex per-flow op_id; T8 (docs/specs/cocoindex-flow-scaffolding/TECH.md §P-4)';
