...
/**
 * POST /api/items/:id/files — Upload the item's PDF to the Anthropic Files API.
 * Returns the file_id for use in subsequent Claude messages.
 */
...
/**
 * DELETE /api/items/:id/files — Remove the item's file from the Anthropic Files API.
 */
