...
/**
 * GET /api/intelligence/workspaces/:id/rss/filtered — Public RSS 2.0 feed of
 * filtered (near-miss) articles.
 *
 ...
 *
 * This feed exposes relevance reasoning (evaluation criteria), so the
 * unauthenticated posture matters more here than on the passed feed — see
 * task id-166.
 *
 * Query params:
