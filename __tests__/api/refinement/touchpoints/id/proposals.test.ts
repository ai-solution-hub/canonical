...
import { GET } from '@/app/api/refinement/touchpoints/[id]/proposals/route';
...
describe('GET /api/refinement/touchpoints/[id]/proposals', () => {
  beforeEach(() => {
    resetMocks();
  });
