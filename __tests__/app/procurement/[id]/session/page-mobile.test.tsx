 ...
 * - ProcurementContextProvider wrapping all return paths (loading, error, empty, main)
 */
...
vi.mock('next/navigation', () => ({
  ...
  usePathname: () => '/procurement/test-bid/session',
...
vi.mock('@/components/procurement/procurement-context-provider', () => ({
  ProcurementContextProvider: ({
    ...
    <div data-testid="bid-context-provider" data-bid-id={procurementId}>
      {children}
    </div>
  ),
}));
...
// Import AFTER mocks
import ProcurementSessionPage from '@/app/procurement/[id]/session/page';
...
function makeStreamCoordinationReturn(overrides: Record<string, unknown> = {}) {
  ...
  return {
    bid: overrides.bid ?? { id: 'test-bid', name: 'Test Procurement Alpha' },
    questions,
    currentIndex,
    ...
    currentQuestion,
    fetchProcurementData: overrides.fetchProcurementData ?? vi.fn(),
...
describe('Session Page Mobile Layout', () => {
  ...
  // ========================================================================
  // ProcurementContextProvider wraps all return paths
  // ========================================================================

  describe('ProcurementContextProvider wraps all return paths', () => {
    it('wraps loading state in ProcurementContextProvider', () => {
    ...
    it('wraps error state in ProcurementContextProvider', () => {
    ...
    it('wraps empty state (no bid) in ProcurementContextProvider', () => {
    ...
    it('wraps empty state (no questions) in ProcurementContextProvider', () => {
      setupDefaults({
        questions: [],
    ...
    it('wraps main session content in ProcurementContextProvider', () => {
      setupDefaults();
      render(<ProcurementSessionPage params={mockParams} />);
