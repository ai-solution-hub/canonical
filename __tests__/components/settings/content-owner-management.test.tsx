...
describe('ContentOwnerManagement', () => {
  ...
  describe('Assign dialog', () => {
    it('opens the dialog with the owner picker (by-domain scope retired, DR-130)', async () => {
      ...
      // The former scope toggle and domain/subtopic/content-type filters
      // are gone with the subject taxonomy (DR-130).
