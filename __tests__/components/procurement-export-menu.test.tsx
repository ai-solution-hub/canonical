/**
 * ProcurementExportMenu Component Tests
 *
...
describe('ProcurementExportMenu', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('fetches DOCX export and shows success toast', async () => {
    ...
    await waitFor(() => {
      expect(globalThis.fetch).toHaveBeenCalledWith(
        '/api/procurement/bid-42/export/docx',
  ...
  it('fetches XLSX export and shows success toast', async () => {
    ...
    await waitFor(() => {
      expect(globalThis.fetch).toHaveBeenCalledWith(
        '/api/procurement/bid-42/export/xlsx',
        expect.objectContaining({ method: 'POST' }),
      );
    });
