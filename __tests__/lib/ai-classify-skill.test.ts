...
describe('Classification skill file', () => {
  ...
  it('contains required entity extraction rules section', () => {
    expect(skillContent).toContain('## Entity Extraction Quality');
  ...
  it('contains summary and title guidance', () => {
    expect(skillContent).toContain('## Summary and Title');
  ...
  it('contains relationship extraction guidance', () => {
    expect(skillContent).toContain('## Entity and Relationship Extraction');
...
describe('Classification skill placeholder interpolation', () => {
  ...
  it('preserves markdown structure after interpolation', () => {
    ...
    expect(interpolated).toContain('## Entity Extraction Quality');
    expect(interpolated).toContain('## Entity Type Guidance');
    expect(interpolated).toContain('## Classification Output');
  });
});
