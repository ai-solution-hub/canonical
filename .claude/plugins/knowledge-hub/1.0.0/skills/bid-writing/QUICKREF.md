...
```
1. OPENING (10-15%)  — Directly answer. Never start with "We".
2. BODY (60-70%)     — Evidence and explanation. Subheadings if >300 words.
3. EVIDENCE (15-20%) — Case studies, metrics, named standards.
4. CLOSING (5-10%)   — Measurable commitment. No "we look forward to...".
```
...
- Outcome: [Measurable results with metrics]
```

## Evidence Hierarchy

1. Certified outcomes (strongest) — "99.97% uptime, independently audited"
2. Named metrics — "Reduced from 14 days to 3 days"
3. Comparative data — "40% above SLA target"
4. Process evidence — "Quarterly senior management reviews"
5. Commitment statements (weakest) — avoid as sole evidence
