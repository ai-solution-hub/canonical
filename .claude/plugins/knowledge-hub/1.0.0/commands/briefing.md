...
|  Tell Claude your priorities and active bids; get a     |
|  structured briefing and prioritised action list        |
+---------------------------------------------------------+
|  SUPERCHARGED (when you connect your tools)             |
|  Claude pulls live reorientation data, bid status,      |
...
Also call `list_active_bids` to get the current bid pipeline overview.
...
Alternatively, tell me about your current priorities, active bids, and
...
### Bid Activity
- [Bid Name]: [N] new responses drafted
- [Bid Name]: Tender documents uploaded
```

### 5. Present Bid Status

For each active bid, show:
...
Sort bids by urgency (closest deadline with most gaps first).
...
## Active Bids
[Bid summaries sorted by urgency]
...
---
[N] urgent items | [N] active bids | [N] items updated recently
```
