...
Complete guide to writing effective agent system prompts that enable autonomous,
...
**Output Format:** Provide results structured as:
...
**Output Format:** Create [what] with:
...
Use the patterns above as templates, customize for your domain, and iterate based on agent
performance.
