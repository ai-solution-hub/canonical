...
Full per-script argument tables, the two monitoring primitives compared, and how to
read a worker's output. The body's *Lifecycle* section covers the common path; this is
