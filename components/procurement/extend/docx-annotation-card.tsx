...
// Our Badge (components/ui/badge.tsx, kept as our own — DR-063 vendor-in
// policy §J2) has no success/error/warning/info variants, only
// default/secondary/destructive/outline/ghost/link — mapped to the closest
// available semantic instead of extending the shared app-wide Badge
// primitive (out of this Subtask's file ownership, ID-147.6).
