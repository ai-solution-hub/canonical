...
} from '@/components/procurement/extend/docx-annotation-card';
import {
  DropdownMenu,
      ...
      <TooltipProvider>
        ...
        <div className="flex min-h-12 flex-wrap items-center gap-2 border-b px-3 py-2">
              ...
              return (
                <>
                  ...
                  >
                    ...
                    <SelectContent align="start" className="z-40 min-w-[210px]">
          ...
          >
            ...
            <SelectContent align="start" className="z-40">
          ...
          <div className="ml-auto flex flex-none items-center gap-1">
            ...
            >
              ...
              <SelectContent align="end" className="z-40">
