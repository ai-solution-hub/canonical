...
> Human Interface Guidelines (HIG) essentials, iOS design conventions, SF Pro typography,
> and native patterns. **Read this file when building for iPhone/iPad.**
...
> **Remember:** iOS users have strong expectations from other iOS apps. Deviating from HIG
> patterns feels "broken" to them. When in doubt, use the native component.
