...
> **Remember:** These trees are guides for THINKING, not rules to follow blindly. Every
> project has unique constraints. ASK clarifying questions when requirements are vague,
> and choose based on actual needs, not defaults.
