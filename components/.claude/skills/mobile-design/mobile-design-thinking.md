...
> Mechanisms to prevent standard AI training defaults in mobile development. **The mobile
> equivalent of frontend's layout decomposition approach.**
...
The following patterns are "defaults" that AIs learned from training data. Before using
any of these, **QUESTION them and CONSIDER ALTERNATIVES!**
...
> **Remember:** If you chose a solution "because that's how it's always done," you chose
> WITHOUT THINKING. Every project is unique. Every context is different. Every user
> behavior is specific. **THINK, then code.**
