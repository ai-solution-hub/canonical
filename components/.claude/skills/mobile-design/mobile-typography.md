...
> **Remember:** If users can't read your text, your app is broken. Typography isn't
> decoration—it's the primary interface. Test on real devices, in real conditions, with
