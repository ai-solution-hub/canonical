...
> **Mobile testing is NOT web testing. Different constraints, different strategies.** This
> file teaches WHEN to use each testing approach and WHY. **Code examples are minimal -
...
> **Remember:** Good mobile testing is about testing the RIGHT things, not EVERYTHING. A
> flaky E2E test is worse than no test. A failing unit test that catches a bug is worth
> 100 passing trivial tests.
