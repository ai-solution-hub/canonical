...
> OLED optimization, dark mode, battery-aware colors, and outdoor visibility. **Color on
> mobile isn't just aesthetics—it's battery life and usability.**
...
> **Remember:** Color on mobile must work in the worst conditions—bright sun, tired eyes,
> colorblindness, low battery. Pretty colors that fail these tests are useless colors.
