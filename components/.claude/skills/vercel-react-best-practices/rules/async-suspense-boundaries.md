...
Instead of awaiting data in async components before returning JSX, use Suspense boundaries
...
**Trade-off:** Faster initial paint vs potential layout shift. Choose based on your UX
priorities.
