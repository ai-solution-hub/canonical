/**
 * VENDORED from task-view @ v0.10.1-task-view (packages/server/detect-schema.ts).
 * Body byte-faithful; only the schema import specifiers are rewired from
 ...
 * to v0.10.1 — registers `kind:'initiatives'` (repurposed roadmap arm,
 * TECH §3.1(b)/§3.2, INV-12(a)); see lib/ledger/README.md for the full
