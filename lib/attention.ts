...
// (id-417 / DR-130: unclassified_count and the taxonomy-coverage insight
// retired with the subject-taxonomy axis — its sentinel columns dropped.)
...
export function produceStaleContentItems(
  ...
  if (expiredCount > 0) {
    items.push({
      ...
      action_url: '/library?freshness=expired',
  ...
  if (staleCount > 0) {
    items.push({
      ...
      action_url: '/library?freshness=stale',
  ...
  return [
    {
      ...
      action_url: '/library?has_quality_flags=true',
  ...
  return [
    {
      ...
      action_url: '/library?verified=false',
  ...
  return [
    {
      ...
      action_url: '/library?expiring_soon=true',
