 ...
 * surface-specific schema (e.g. `@/lib/validation/task-list-schema`).
 * No barrel re-export via index.ts per CLAUDE.md convention.
 *
 ...
 *                — applied in task-list-schema.ts ('cancelled' is retained
 *                at Subtask level per S261 Liam request).
