...
//
// URL + ANON_KEY come from `clientEnv` (Zod-validated at boot in
// `lib/env.ts`) — no defensive placeholder-fallback needed because the
// build fails fast if either var is missing.
