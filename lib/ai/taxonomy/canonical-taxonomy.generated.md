<!-- FROZEN artefact — its generator (scripts/generate-classification-prompt-taxonomy.ts)
     was retired with the DR-130 taxonomy retirement. Kept only because
     scripts/bundle-plugin.ts validates/bundles it; its fate belongs to the
     id-71 A5 plugin review. -->
