 ...
 *
 * Registers 36 tools across 10 category files:
 ...
 *   - quality.ts    (6): get_quality_summary, get_coverage_gaps, audit_content, find_all_duplicates, suggest_content_creation, get_quality_briefing
